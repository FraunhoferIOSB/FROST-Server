...
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.ActuatorFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.DatastreamFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.EntityFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.FeatureOfInterestFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.HistoricalLocationFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.LocationFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.MultiDatastreamFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.ObservationFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.ObservedPropertyFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.SensorFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.TaskFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.TaskingCapabilityFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.factories.ThingFactory;
...
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.relationalpaths.AbstractQObsProperties;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.relationalpaths.AbstractQObservations;
import de.fraunhofer.iosb.ilt.frostserver.persistence.postgres.relationalpaths.AbstractQSensors;
