...
`frost.http.ports.http.externalServicePort` | The external port of the FROST-Server HTTP module, when ingress is enabled (used if not other than standard http(s) port is used)                                                                                                                     | `nil`
