...
`image.bus.registry`                        | Image registry for the bus                                                                                                                                                                                                                            | `docker.io`
`image.bus.repository`                      | Image for the bus                                                                                                                                                                                                                                     | `eclipse-mosquitto`
`image.bus.tag`                             | Imagetag for the bus                                                                                                                                                                                                                                  | `1.4.12`
`image.bus.pullPolicy`                      | Image pull policy for the bus                                                                                                                                                                                                                         | `IfNotPresent`
`image.db.registry`                         | Image registry for the database                                                                                                                                                                                                                       | `docker.io`
`image.db.repository`                       | Image for the database                                                                                                                                                                                                                                | `mdillon/postgis`
`image.db.tag`                              | Imagetag for the database                                                                                                                                                                                                                             | `10`
`image.db.pullPolicy`                       | Image pull policy for the bus                                                                                                                                                                                                                         | `IfNotPresent`
`image.http.registry`                       | Image registry for the http module                                                                                                                                                                                                                    | `docker.io`
`image.http.repository`                     | Image for the http module                                                                                                                                                                                                                             | `fraunhoferiosb/frost-server-http`
`image.http.tag`                            | Imagetag for the http module                                                                                                                                                                                                                          | `{VERSION}`
`image.http.pullPolicy`                     | Image pull policy for the http module                                                                                                                                                                                                                 | `IfNotPresent`
`image.mqtt.registry`                       | Image registry for the mqtt module                                                                                                                                                                                                                    | `docker.io`
`image.mqtt.repository`                     | Image for the mqtt module                                                                                                                                                                                                                             | `fraunhoferiosb/frost-server-mqtt`
`image.mqtt.tag`                            | Imagetag for the mqtt module                                                                                                                                                                                                                          | `{VERSION}`
`image.mqtt.pullPolicy`                     | Image pull policy for the mqtt module                                                                                                                                                                                                                 | `IfNotPresent`
