...
{{ .Values.frost.http.serviceProtocol }}://{{ .Values.frost.http.serviceHost }}{{ if not .Values.frost.http.ingress.enabled }}:{{ .Values.frost.http.ports.http.nodePort }}{{ else if .Values.frost.http.externalServicePort }}:{{ .Values.frost.http.externalServicePort }}{{ end }}
{{- end -}}
