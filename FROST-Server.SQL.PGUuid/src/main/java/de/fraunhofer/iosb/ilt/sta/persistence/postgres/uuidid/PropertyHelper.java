...
public class PropertyHelper {
    ...
    public static Datastream datastreamFromId(UUID id) {
        if (id == null) {
            return null;
        }
    ...
    public static MultiDatastream multiDatastreamFromId(UUID id) {
        if (id == null) {
            return null;
        }
    ...
    public static FeatureOfInterest featureOfInterestFromId(UUID id) {
        if (id == null) {
            return null;
        }
    ...
    public static ObservedProperty observedProperyFromId(UUID id) {
        if (id == null) {
            return null;
        }
    ...
    public static Sensor sensorFromId(UUID id) {
        if (id == null) {
            return null;
        }
    ...
    public static Thing thingFromId(UUID id) {
        if (id == null) {
            return null;
        }
