...
/**
 * Holds the settings for the OIDC Auth Provider.
 */
public class OidcSettings extends ConfigProvider<OidcSettings> {
    ...
    @DefaultValue("de.fraunhofer.iosb.ilt.frostserver.auth.oidc.UserRoleDecoderDflt")
