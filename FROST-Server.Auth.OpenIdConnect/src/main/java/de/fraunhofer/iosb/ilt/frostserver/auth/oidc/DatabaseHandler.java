...
import static de.fraunhofer.iosb.ilt.frostserver.auth.oidc.OidcSettings.TAG_USER_CACHE_CLEANUP_INTERVAL;
import static de.fraunhofer.iosb.ilt.frostserver.auth.oidc.OidcSettings.TAG_USER_CACHE_LIFETIME;
import static de.fraunhofer.iosb.ilt.frostserver.auth.oidc.OidcSettings.TAG_USER_ROLE_DECODER_CLASS;
...
public class DatabaseHandler {
    ...
    private DatabaseHandler(CoreSettings coreSettings) {
        ...
        String userRoleDecoderClass = authSettings.get(TAG_USER_ROLE_DECODER_CLASS, OidcSettings.class);
        String lifeTimeString = authSettings.get(TAG_USER_CACHE_LIFETIME, OidcSettings.class);
        ...
        String cleanupIntervalString = authSettings.get(TAG_USER_CACHE_CLEANUP_INTERVAL, OidcSettings.class);
