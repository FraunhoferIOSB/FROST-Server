...
import static de.fraunhofer.iosb.ilt.frostserver.auth.oidc.OidcSettings.TAG_USERNAME_COLUMN;
import static de.fraunhofer.iosb.ilt.frostserver.auth.oidc.OidcSettings.TAG_USER_TABLE;
...
public class UserRoleDecoderDflt implements UserRoleDecoder {
    ...
    public void init(CoreSettings coreSettings) {
        ...
        userTable = authSettings.get(TAG_USER_TABLE, OidcSettings.class);
        usernameColumn = authSettings.get(TAG_USERNAME_COLUMN, OidcSettings.class);
    }
