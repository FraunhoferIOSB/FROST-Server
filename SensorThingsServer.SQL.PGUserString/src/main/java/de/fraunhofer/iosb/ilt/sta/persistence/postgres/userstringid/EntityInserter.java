...
public class EntityInserter {
    ...
    private final PostgresPersistenceManagerUserString pm;
    private ObjectMapper formatter;

    public EntityInserter(PostgresPersistenceManagerUserString pm) {
        this.pm = pm;
    }
    ...
    public boolean insertDatastream(Datastream ds) throws NoSuchEntityException, IncompleteEntityException {
        ...
        insert.set(qd.phenomenonTimeStart, new Timestamp(PostgresPersistenceManagerUserString.DATETIME_MAX.getMillis()));
        insert.set(qd.phenomenonTimeEnd, new Timestamp(PostgresPersistenceManagerUserString.DATETIME_MIN.getMillis()));
        insert.set(qd.resultTimeStart, new Timestamp(PostgresPersistenceManagerUserString.DATETIME_MAX.getMillis()));
        insert.set(qd.resultTimeEnd, new Timestamp(PostgresPersistenceManagerUserString.DATETIME_MIN.getMillis()));
