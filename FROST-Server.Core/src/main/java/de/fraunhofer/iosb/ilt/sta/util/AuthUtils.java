...
import static de.fraunhofer.iosb.ilt.sta.settings.CoreSettings.TAG_AUTH_ROLE_READ;
import static de.fraunhofer.iosb.ilt.sta.settings.CoreSettings.TAG_AUTH_ROLE_UPDATE;
