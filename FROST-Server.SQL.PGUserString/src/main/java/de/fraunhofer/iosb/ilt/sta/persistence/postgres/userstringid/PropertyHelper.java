...
public class PropertyHelper {
    ...
    public static class DatastreamFactory implements PropertyHelper.entityFromTupleFactory<Datastream> {
        ...
        public static final DatastreamFactory withDefaultAlias = new DatastreamFactory(new QDatastreams(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class MultiDatastreamFactory implements PropertyHelper.entityFromTupleFactory<MultiDatastream> {
        ...
        public static final MultiDatastreamFactory withDefaultAlias = new MultiDatastreamFactory(new QMultiDatastreams(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class ThingFactory implements PropertyHelper.entityFromTupleFactory<Thing> {
        ...
        public static final ThingFactory withDefaultAlias = new ThingFactory(new QThings(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class FeatureOfInterestFactory implements PropertyHelper.entityFromTupleFactory<FeatureOfInterest> {
        ...
        public static final FeatureOfInterestFactory withDefaultAlias = new FeatureOfInterestFactory(new QFeatures(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class HistoricalLocationFactory implements PropertyHelper.entityFromTupleFactory<HistoricalLocation> {
        ...
        public static final HistoricalLocationFactory withDefaultAlias = new HistoricalLocationFactory(new QHistLocations(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class LocationFactory implements PropertyHelper.entityFromTupleFactory<Location> {
        ...
        public static final LocationFactory withDefaultAlias = new LocationFactory(new QLocations(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class SensorFactory implements PropertyHelper.entityFromTupleFactory<Sensor> {
        ...
        public static final SensorFactory withDefaultAlias = new SensorFactory(new QSensors(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class ObservationFactory implements PropertyHelper.entityFromTupleFactory<Observation> {
        ...
        public static final ObservationFactory withDefaultAlias = new ObservationFactory(new QObservations(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
    ...
    public static class ObservedPropertyFactory implements PropertyHelper.entityFromTupleFactory<ObservedProperty> {
        ...
        public static final ObservedPropertyFactory withDefaultAlias = new ObservedPropertyFactory(new QObsProperties(PathSqlBuilderUserString.ALIAS_PREFIX + "1"));
     ...
     * PathSqlBuilderUserString.ALIAS_PREFIX + "1".
     *
