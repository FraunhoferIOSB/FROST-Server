 ...
 * @author scf
 */
public class PathSqlBuilderUserString implements PathSqlBuilder {
     ...
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(PathSqlBuilderUserString.class);
    /**
