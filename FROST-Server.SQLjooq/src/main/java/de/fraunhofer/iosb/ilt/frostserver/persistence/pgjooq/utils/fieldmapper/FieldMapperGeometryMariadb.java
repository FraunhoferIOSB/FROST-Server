...
/**
 * A Geometry FieldMapper for MariaDB.
 */
public class FieldMapperGeometryMariadb extends FieldMapperAbstractEp {
     ...
     * @return this.
     */
    public FieldMapperGeometryMariadb setFieldSource(String fieldSource) {
