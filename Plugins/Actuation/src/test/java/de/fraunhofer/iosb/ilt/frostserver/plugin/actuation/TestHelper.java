...
public class TestHelper {
    ...
    public static void generateDefaultValues(Map<Property, Object> propertyValues, PluginCoreModel pluginCoreModel, PluginActuation pluginActuation, ModelRegistry modelRegistry) {
