 ...
 * JSON input!
 */
public class JsonReaderOData implements JsonReader {
     ...
     */
    public JsonReaderOData(ModelRegistry modelRegistry, Version version) {
     ...
     */
    public JsonReaderOData(ModelRegistry modelRegistry, Version version, PrincipalExtended user) {
     ...
     */
    public JsonReaderOData(ModelRegistry modelRegistry, Version version, boolean isAdmin) {
