...
public class JsonReaderOData implements JsonReader {
     ...
     */
    public JsonReaderOData(ModelRegistry modelRegistry) {
     ...
     */
    public JsonReaderOData(ModelRegistry modelRegistry, PrincipalExtended user) {
     ...
     */
    public JsonReaderOData(ModelRegistry modelRegistry, boolean isAdmin) {
