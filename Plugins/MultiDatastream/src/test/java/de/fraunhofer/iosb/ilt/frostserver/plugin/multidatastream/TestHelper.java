...
public class TestHelper {
    ...
    public static void generateDefaultValues(Map<Property, Object> propertyValues, PluginCoreModel pluginCoreModel, ModelRegistry modelRegistry) {
        ...
        propertyValues.put(StandardProperties.EP_ENCODINGTYPE, "My EncodingType");
        propertyValues.put(pluginCoreModel.epFeature, new Point(8, 42));
        propertyValues.put(pluginCoreModel.etThing.getPrimaryKey().getKeyProperty(0), 1L);
        ...
        propertyValues.put(StandardProperties.EP_PROPERTIES, parameters);
        ...
        ComplexValueImpl unit2 = UnitOfMeasurement.create("unitName2", "unitSymbol2", "unitDefinition2");
        ...
        propertyValues.put(npMultiDatastream, new DefaultEntity(etMultiDatastream, PkValue.of(nextId++)));
        ...
        multiDatastreams.add(new DefaultEntity(etMultiDatastream, PkValue.of(nextId++)));
        multiDatastreams.add(new DefaultEntity(etMultiDatastream, PkValue.of(nextId++)));
