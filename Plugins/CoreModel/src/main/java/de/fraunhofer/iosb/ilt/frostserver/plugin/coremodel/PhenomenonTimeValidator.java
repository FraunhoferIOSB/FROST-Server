...
/**
 * A Validator for Observation.phenomenonTime. Sets the phenomenonTime to the
 * current time when not set.
 */
public class PhenomenonTimeValidator implements EntityValidator {

    private EntityPropertyMain epPhenomenonTime;
