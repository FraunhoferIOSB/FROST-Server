...
public interface HookPreInsert<J extends Comparable> {
    ...
    public void insertIntoDatabase(OrakelPersistenceManager<J> pm, Entity entity, Map<Field, Object> insertFields) throws NoSuchEntityException, IncompleteEntityException;
