...
import static de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.factories.EntityFactories.CHANGED_MULTIPLE_ROWS;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.factories.HookPreDelete;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.factories.HookPreInsert;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.factories.HookPreUpdate;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.fieldwrapper.JsonFieldFactory;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.relations.Relation;
...
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.utils.SortingWrapper;
...
public abstract class StaTableAbstract<J extends Comparable, T extends StaMainTable<J, T>> extends TableImpl<Record> implements StaMainTable<J, T> {
    ...
    @Override
    public boolean insertIntoDatabase(OrakelPersistenceManager<J> pm, Entity entity) throws NoSuchEntityException, IncompleteEntityException {
     ...
     */
    protected void updateNavigationPropertySet(Entity entity, EntitySet linkedSet, OrakelPersistenceManager<J> pm, boolean forInsert) throws IncompleteEntityException, NoSuchEntityException {
    ...
    @Override
    public EntityChangedMessage updateInDatabase(OrakelPersistenceManager<J> pm, Entity entity, J entityId) throws NoSuchEntityException, IncompleteEntityException {
        final T thisTable = getThis();
        EntityFactories<J> entityFactories = pm.getEntityFactories();
        EntityType entityType = entity.getEntityType();
