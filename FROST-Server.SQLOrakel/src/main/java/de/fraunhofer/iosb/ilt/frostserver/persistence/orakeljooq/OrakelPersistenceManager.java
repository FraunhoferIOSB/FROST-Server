...
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.tables.StaLinkTableDynamic;
...
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.utils.ConnectionUtils;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.utils.ConnectionUtils.ConnectionWrapper;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.utils.DataSize;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.utils.LiquibaseHelper;
import de.fraunhofer.iosb.ilt.frostserver.persistence.orakeljooq.utils.fieldmapper.FieldMapper;
 ...
 */
public abstract class OrakelPersistenceManager<J extends Comparable> extends AbstractPersistenceManager {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(OrakelPersistenceManager.class.getName());
    ...
    public OrakelPersistenceManager(IdManager idManager) {
    ...
    public DSLContext getDslContext() {
        if (dslContext == null) {
            dslContext = DSL.using(connectionProvider.get(), SQLDialect.DEFAULT);
        }
        return dslContext;
    }
